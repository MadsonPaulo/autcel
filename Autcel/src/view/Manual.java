...
public class Manual extends JFrame {
	...
	public Manual(int language) {
		...
		if (language == 0) {
			...
			// texto
			texts[0] = "<h2>O que é o Autcel?</h2>Autcel permite criar, editar e executar autômatos celulares. Possui 3 telas: Configuração, Regras e Execução.<br><br><h2>Licença</h2>Este projeto usa a licença AGPL v3.0. Mais detalhes em: <a href=\"https://www.gnu.org/licenses/\">https://www.gnu.org/licenses/</a><br><br><h2>GitHub</h2>Você pode encontrar o código fonte deste projeto no GitHub em: <a href=\"https://github.com/MadsonPaulo/autcel\">https://github.com/MadsonPaulo/autcel</a>.<br>Sinta-se livre para contribuir com este projeto. ";
			texts[1] = "<h2>Configuração</h2>A tela inicial, Configuração, permite definir o estado inicial das células, a quantidade de estados possíveis e o nome dos estados. É possível também importar um modelo anteriormente criado através do Autcel ou utilizar um dos modelos prontos. Note que ao importar ou utilizar um modelo pronto, a tela Configuração será fechada, a tela de Regras será pulada e será aberta a tela de Execução.<br><br><h2>Alterando o estado inicial de uma célula</h2>Para alterar o estado inicial de uma célula, basta clicar na célula com o botão esquerdo do mouse e ela irá mudar sua cor para a correspondente ao próximo estado possível. Ao finalizar, clique em no botão \"Avançar\".";
			texts[2] = "<h2>Regras</h2>A tela Regras permite definir as regras válidas no autômato. No canto superior existem dois botões, \"Jogo da Vida\" e \"Cristais de Ulam\". Ao clicar em um desses, qualquer regra existente será apagada e as regras serão configuradas para as do autômato do botão clicado.<br><br><h2>Criando uma regra</h2>Para criar uma regra, clique numa das caixas de seleção ou no botão \"Nova Regra\". O campo de texto logo à direita irá mostrar a regra em linguagem natural. Ao alterar alguma caixa de seleção, a regra em linguagem natural será atualizada. Quando a regra estiver pronta, clique em \"Criar Regra\".<br><br><h2>Precedência das Regras</h2>As regras seguem ordem de precedência de cima para baixo, logo, uma vez que uma regra seja validada para uma célula em um ciclo, as demais regras serão ignoradas para esta célula neste ciclo. É possível alterar a precedência de uma regra selecionando-a e clicando nos botões \"Acima\" e \"Abaixo\".<p>Para excluir uma regra, selecione-a e clique em \"Excluir\". É necessário definir pelo menos uma regra para avançar.</p>";
			texts[3] = "<h2>Execução</h2>A tela de Execução permite executar o autômato e exportá-lo. No canto superior esquerdo é possível ver o ciclo atual. Logo abaixo está o painel de escala, onde estão as opções de aumentar ou diminuir a escala para melhor visualização.<br><br><h2>Avançando Ciclos</h2>O painel de avanço manual fica abaixo do painel de escala. Clicando em \"Próximo\" avança para o próximo ciclo e em \"Anterior\", retorna um ciclo. Logo abaixo está o painel de avanço automático. Basta selecionar o intervalo em milissegundos para o avanço de cada turno e clicar em \"Iniciar\" para iniciar o avanço automático. É possível pará-lo clicando no botão \"Parar\", que aparece somente quando o avanço automático está ativo.<br><br><h2>População</h2>No canto inferior esquerdo está o painel de estados. À esquerda são exibidos o nome dos oito estados e à direita, a cor e a população de cada estado no ciclo atual.<p>Para voltar para a tela Regras basta clicar em \"Voltar\".</p>";
		} else if (language == 1) {
			// título
